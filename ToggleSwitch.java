...
/*
 * @ https://stackoverflow.com/questions/9146683/is-there-a-standard-gui-toggle-switch-in-java
 */
...
public class ToggleSwitch extends JPanel {
    ...
    public void paint(Graphics gr) {
        if(g == null || puffer.getWidth() != getWidth() || puffer.getHeight() != getHeight()) {
            puffer = (BufferedImage) createImage(this.getWidth(), this.getHeight());
            //puffer = (BufferedImage) createImage(50, 20);
    ...
    /**
     * Deactivated Background Color of switch
     */
